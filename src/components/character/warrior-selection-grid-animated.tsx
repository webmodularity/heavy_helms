...
export function WarriorSelectionGridAnimated({
  ...
  const [previousSelectedId, setPreviousSelectedId] = useState<
    string | number | null
  >(null);
  const [justSelectedId, setJustSelectedId] = useState<string | number | null>(
    null,
  );
  const [hoveredCharacterId, setHoveredCharacterId] = useState<
    string | number | null
  >(null);
  ...
  const handleCharacterSelect = useCallback(
    async (character: Player, newStance?: StanceType) => {
