...
export function SelectionAnimationEffects({
  ...
  const previousPos = previousSelectedId
    ? getCardPosition(previousSelectedId)
    : null;
  const currentPos = selectedCharacterId
    ? getCardPosition(selectedCharacterId)
    : null;
  const hoveredPos = hoveredCharacterId
    ? getCardPosition(hoveredCharacterId)
    : null;
